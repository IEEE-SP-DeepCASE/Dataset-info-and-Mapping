 ...
 * `mappings`, a directory containing `.json` files for both the AlienVault and Sigma rules and `.csv` files containing the mappings from AlienVault and Sigma events to our Company events.
...
|Company blocking test                             |Unusual External IP Lookup                        |
|Company sensor rule test                          |Unusual HTTP Basic Authentication                 |
|Company test                                      |Unusual JA3 fingerprint observed                  |
